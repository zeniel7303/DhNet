...
{
private:
    // Helper to dispatch work to the logic thread and wait for completion with timeout
    template<typename Fn>
    bool DispatchToLogicThreadWithTimeout(Fn&& fn, std::chrono::milliseconds timeout, std::string& err);
